...
public class Const {
    ...
    public static final String METHOD_MARKER_SELECT = "marker#select";
    public static final String[] METHOD_ID_LIST_FOR_MARKER = {METHOD_MARKER_UPDATE, METHOD_MARKER_DESELECT, METHOD_MARKER_SELECT};
